...
import pop_path from "components/data/pyramid/pop_path.json";
import jpop_path1 from "components/data/pyramid/jpop_path1.json";
import jpop_path2 from "components/data/pyramid/jpop_path2.json";
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      // var e1 = options3.filter((s) => e.nid == s.value);
                      //  setOp3(e1[0]);
                      //router.push(`/pyramid/${e.value}`).then(() => router.reload());
                      router.push(`/pyramid/${e.value}`);
                    }}
                  />
                </Grid>
